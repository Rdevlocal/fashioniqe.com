...
const ProductPage = async ({ params }: Props) => (
  <section className="pt-14">
    ...
    >
      <AllProducts id={params.id} gender={params.gender} />
    </Suspense>
  </section>
);

const AllProducts = async ({ id, gender }: { id: string; gender: string }) => {
  ...
  const similarProducts = await getCategoryProducts(gender);
