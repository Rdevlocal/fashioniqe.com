        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/men" className="text-gray-400 hover:text-white">Men</Link>
              </li>
              <li>
                <Link href="/women" className="text-gray-400 hover:text-white">Women</Link>
              </li>
              <li>
                <Link href="/sale" className="text-gray-400 hover:text-white">Sale</Link>
              </li>
              <li>
                <Link href="/categories" className="text-gray-400 hover:text-white">All Categories</Link>
              </li>
          ...
          <div>
            <h2 className="text-lg font-semibold mb-4 text-white">Legal & Account</h2>
            <ul className="space-y-2">
              <li>
              ...
              <li>
                <Link href="/wishlist" className="text-gray-400 hover:text-white">Wishlist</Link>
              </li>
              <li className="pt-2 mt-2 border-t border-gray-800">
          ...
          <div>
            ...
            <div className="mt-6 text-sm text-gray-400">
              <p>Get price alerts for your favorite items!</p>
              <Link href="/search" className="text-blue-400 hover:underline mt-1 inline-block">
                Start browsing →
              </Link>
            </div>
          </div>
